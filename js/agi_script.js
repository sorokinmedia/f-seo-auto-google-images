...
function addHtml() {
    ...
    jQuery('.agi_window').append('<div class="agi_results"></div><div class="agi_pagination"><span class="agi_pages prev_p"></span><span class="numpage"></span><span class="agi_pages next_p"></span></div><span class="popap_cross"></span>');
